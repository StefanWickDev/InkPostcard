...
namespace InkPostcard
{
    ...
    {
        private Color _fill = Colors.White, _stroke = Colors.Black;
        /// <summary>
            ...
            : base()
        {
            ...
            this.DynamicRenderer.DrawingAttributes.Color = _fill;
            this.DynamicRenderer.DrawingAttributes.Width = 5d;
            this.DynamicRenderer.DrawingAttributes.Height = 5d;
            ...
            outerDynamicRenderer.DrawingAttributes.Color = _stroke;
        ...
        public Color Color
        {
            get { return this.DefaultDrawingAttributes.Color; }
            set
            {
                _fill = value;
                this.DefaultDrawingAttributes.Color = _fill;
                _stroke = Color.FromRgb((byte)(255-value.R), (byte)(255 - value.G), (byte)(255 - value.B));
                outerDynamicRenderer.DrawingAttributes.Color = _stroke;
            }
        }
        ...
        private DrawingAttributes GetOutlineDrawingAttributes(DrawingAttributes oirginalDrawingAttributes)
        {
            ...
            newDrawingAttributes.Color = _stroke;
